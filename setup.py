...
INSTALL_REQUIRES = ["skia-pathops", "cython"]
# Optional packages
EXTRAS_REQUIRES = {
...
# Version
main_namespace = {}
version_fp = os.path.join(this_file_path, "lib", "pathins", "__init__.py")
try:
...
setup(
    ...
    entry_points={"console_scripts": ["pathins = pathins.__main__:main"]},
    classifiers=[
